...
},{"./lib/axios":"node_modules/axios/lib/axios.js"}],"redux/recipes.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.default = exports.getRecipes = void 0;
...
const RECIPE_FETCH_FAIL = "RECIPE_FETCH_FAIL"; // ACTIONCREATORS
...
const getRecipes = str => async (dispatch, getState) => {
  ...
  try {
    const response = await (0, _axios.default)(`https://www.thecocktaildb.com/api/json/v1/1/filter.php?i=${getState().recipeState.recipe}`); // console.log(response.data.drinks);
...
document.getElementById("recipesform").onsubmit = e => {
  ...
  _store.default.dispatch((0, _recipes.getRecipes)(document.querySelector("#recipesform input").value));
...
function recipeRender() {
  const {
    ...
    loading,
    recipes
  } = _store.default.getState().recipeState;
  ...
  if (recipes) {
    document.getElementById("recipesgrid").innerHTML = recipes.map(recipe => `<li class="drink">${recipe.strDrink}</li>`).join("");
  } else {
...
_store.default.subscribe(recipeRender);
},{"./redux/store.js":"redux/store.js","./redux/counter.js":"redux/counter.js","./redux/recipes.js":"redux/recipes.js"}],"../../../../usr/local/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
...
//# sourceMappingURL=/dz.e31bb0bc.js.map